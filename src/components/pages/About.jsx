...
function About() {
  return (
    <div className="about-box ">
      <div className="about-first position-relative ">
        <div className="header position-absolute mt-sm-4 start-50 translate-middle-x ">
          <div class="gdsc mt-3">Google Developer Student Clubs</div>
          <div class="usa">University of San Agustin</div>
          <p class="mt-md-5 mt-4">
            ...
            sed a tincidunt. Aliquet gravida condimentum donec ipsum.
          </p>
        </div>
      </div>
      ...
      <div className="about-mission ">
        <div class="mission-flex d-flex justify-content-center  ">
          ...
          <div class="container con1">
            <img class="mt-2" src={sample} alt="Sample" />
          </div>
        </div>
      </div>
      <div className="about-mission ">
        <div class="mission-flex d-flex justify-content-center  ">
          ...
          <div class="container text-center mt-md-5">
            <h1 class="ms-sm-1">Our vission</h1>
            <p class="ms-sm-1 mt-sm-5">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vel
              mauris mattis tempor elementum eget tortor mi nec auctor.
              Vulputate enim tortor augue et est vulputate etiam ut magna. Et
